// FIXME: Temporary hardcoded ingredients and others
// If API will be ready, then fetch from API.
...
export interface ICategorizedIngredients {
    category: Category;
    ingredients: Ingredient[];
}

export const categorizedIngredients: ICategorizedIngredients[] = [
    { 
    ...
    },
    {
        ...
        ingredients: [
            ingredients.citrus,
            ingredients.orange,
            ingredients.whole_apple
        ]
    },
    {
        category: Category.SEAFISH,
        ingredients: [
            ingredients.fish_food
        ]
    },
    {
